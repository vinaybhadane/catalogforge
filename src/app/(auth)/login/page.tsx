    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F8FAFC] p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="w-12 h-12 rounded-xl bg-[#1D4ED8] text-white flex items-center justify-center mx-auto mb-4">
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-xl p-6 shadow-sm space-y-5">
          ...
          {/* Google Sign-In (optional, per §11) */}
          <button
            type="button"
            disabled={submitting}
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-white hover:bg-slate-50 border border-[#CBD5E1] text-slate-700 text-sm font-medium rounded-lg transition-colors disabled:opacity-50"
          >
